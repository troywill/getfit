...
**
** Created: Mon Jan 11 21:17:00 2010
...
static const char qt_meta_stringdata_ArrowLcd[] = {
    "ArrowLcd\0\0pedometerChanged(int)\0"
    "arrowDisplay(int)\0event\0"
    "keyPressEvent(QKeyEvent*)\0countUp()\0"
    "countDown()\0saveSteps(int)\0setPedometer(int)\0"
};
...
int ArrowLcd::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: pedometerChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: arrowDisplay((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: keyPressEvent((*reinterpret_cast< QKeyEvent*(*)>(_a[1]))); break;
        case 3: countUp(); break;
        case 4: countDown(); break;
        case 5: saveSteps((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: setPedometer((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 7;
    }
...
// SIGNAL 0
void ArrowLcd::pedometerChanged(int _t1)
{
